...
**Output:** Loot gunpowder (6) from creepers.
`;
...
export function breakdownContextPrompt(
  ...
  For example, if a previous step acquired a needed resource, and the current step involves crafting using that resource, do not write a step for getting the resource. You already have it.
  Assume you have all materials acquired in previous steps. Also assume your character already has all necessary equipment. ${invString}`;
}
