...
export const tools: ChatCompletionTool[] = [
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Returns a text summary of the bot's current state.",
      parameters: {
        type: "object",
        properties: {},
        required: [],
  ...
  },
  {
    type: "function",
    function: {
      name: "get_shared_state_diff",
      description:
        "Returns a summary of changes since the last captured snapshot.",
      parameters: {
        type: "object",
        properties: {},
        required: [],
